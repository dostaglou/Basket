...
class BasketItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket_item" do
    assert_difference("BasketItem.count") do
      post basket_items_url, params: { basket_item: { basket_id: @basket_item.basket_id, item_id: @basket_item.item_id, measure: @basket_item.measure, name: @basket_item.name, note: @basket_item.note, quantity: @basket_item.quantity } }
    end
  ...
  test "should update basket_item" do
    patch basket_item_url(@basket_item), params: { basket_item: { basket_id: @basket_item.basket_id, item_id: @basket_item.item_id, measure: @basket_item.measure, name: @basket_item.name, note: @basket_item.note, quantity: @basket_item.quantity } }
